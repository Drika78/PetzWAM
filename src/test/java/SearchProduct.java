...
public class SearchProduct extends Base {
    ...
    public void iSeeAListOfProduct(String product)  {
        ...
        assertEquals(" - Produtos pet em promoção | Petz",list.readTitleTab());
    ...
    public void showTheTitleAndPrice(String produtc, String price)  {
        // Validar o nome da guia
        assertEquals(produtc + " - Produtos pet em promoção | Petz", productClass.readTitleTab());

        // Validar o nome do produto
        assertEquals(produtc, productClass.readProductTitle());
